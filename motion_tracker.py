...
# def main():
#     global center_pixel, is_center_set, pixels_per_mm, measurement_unit
...
#                 threshold_display = convert_to_display_units(MOVEMENT_THRESHOLD_MM)
#                 status = "MOVING" if total_dist_display > threshold_display else "STILL"
#                 status_color = (0, 0, 255) if status == "MOVING" else (0, 255, 0)
#                 cv2.putText(frame, f"Status: {status}", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.7, status_color, 2)
